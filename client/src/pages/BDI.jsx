    ...
    try {
        ...
        <>
            ...
            <div>
                ...
                <br/>
                <Choices text = {question[1]} onSquareClick={() => handleClick(1)}/>
                <br/>
                <Choices text = {question[2]} onSquareClick={() => handleClick(2)}/>
                <br/>
                <Choices text = {question[3]} onSquareClick={() => handleClick(3)}/>
                <br/>
            </div>
        </> 
    } catch (error) {
        content = <Submit total={sum}/>
    }
